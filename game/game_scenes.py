...
def caveScene():
    ...
    with col2:
        ...
        if st.session_state["scenes_counter"]["cave_counter"] == 0:
            ...
            audio_file = open("game/audio/cave.mp3", "rb")
            audio_bytes = audio_file.read()
            st.audio(audio_bytes, format="audio/mpeg")
        else:
            st.markdown(
...
def dragonScene():
    ...
    with col2:
        ...
        audio_file = open("game/audio/dragon.mp3", "rb")
        audio_bytes = audio_file.read()
        st.audio(audio_bytes, format="audio/mpeg")
...
def southpathScene():
    ...
    with col2:
        ...
        audio_file = open("game/audio/south.mp3", "rb")
        audio_bytes = audio_file.read()
        st.audio(audio_bytes, format="audio/mpeg")
...
def elfScene():
    ...
    with col2:
        ...
        if st.session_state["scenes_counter"]["elf_counter"] == 0:
            ...
            audio_file = open("game/audio/elf1.mp3", "rb")
            audio_bytes = audio_file.read()
            st.audio(audio_bytes, format="audio/mpeg")
        else:
            st.markdown(
            ...
            audio_file = open("game/audio/elf2.mp3", "rb")
            audio_bytes = audio_file.read()
            st.audio(audio_bytes, format="audio/mpeg")
